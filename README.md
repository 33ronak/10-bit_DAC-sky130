...
The following repository is the documentation to construction of a 10 Bit Pottentiometric Digital to Analog Converter(DAC), using [eSim](https://esim.fossee.in/downloads), [ngspice 35](http://ngspice.sourceforge.net/download.html), and [Skywater 130nm PDK](https://github.com/google/skywater-pdk). All the refrances and contributors are mentioned in aknowledgement.
...
- [3. Post Simulation Observation](#Post Simulation Observation)
...
## Circuit Diagrams
The schematics for a circuit and a 2 bit DAC were designed in eSim. As the analog input voltage was 3.3V, the vdd and vref was set to 3.3V. For the voltage divider circuit, a series of 4 resistors of 250ohm each were used. 
